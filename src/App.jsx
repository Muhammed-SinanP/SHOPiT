    ...
    <>
      ...
      <BrowserRouter>
        <Routes>
          ...
          <Route path="/men's clothing" element={<Main category="men's clothing"/>} />
          <Route path="/women's clothing" element={<Main category="women's clothing"/>} />
          <Route path="/jewelery" element={<Main category="jewelery"/>} />
          <Route path="/electronics" element={<Main category="electronics"/>} />
